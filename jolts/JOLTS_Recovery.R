...
jolts.trim <- jolts.df %>%
  ...
  filter(dataelement_text %in% c("Job openings", "Quits")) %>%
...
write.csv(jolts.trim, file = "C:/Users/sestep/Documents/jolts/data/JOLTS_Rates.csv", row.names=FALSE)
